...
public class CodeTransformationTestGenerated extends AbstractCodeTransformationTest {
    ...
    public static class ConvertNegatedExpressionWithDemorgansLaw extends AbstractCodeTransformationTest {
        ...
        @TestMetadata("inapplicableMixedExpression.kt")
        public void testInapplicableMixedExpression() throws Exception {
            doTestConvertNegatedExpressionWithDemorgansLaw("idea/testData/intentions/convertNegatedExpressionWithDemorgansLaw/inapplicableMixedExpression.kt");
        }
